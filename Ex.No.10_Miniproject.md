...
### AIM: 
To develop a Unity 3D game where an AI-controlled agent uses reinforcement learning (via Unity
ML-Agents) to autonomously navigate through a maze and reach a designated goal,
demonstrating basic principles of artificial intelligence in games 
### Algorithm:
...
```
### Output:
![WhatsApp Image 2025-11-12 at 08 17 06_4fbe0397](https://github.com/user-attachments/assets/cae804e1-66e8-4d19-b003-d3a31d1ce22d)
